...
public class SimpleChatServer {
    ...
    public static class SingleSimpleChatServer{
       public static final SimpleChatServer simpleChatServer = new SimpleChatServer();
    }

    private static SimpleChatServer getInstance(){
        return SingleSimpleChatServer.simpleChatServer;
    }
